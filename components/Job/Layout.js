...
export default function Layout({ children }) {
  ...
  return (
    <>
      <div className="relative z-10 min-h-screen md:flex bg-gray-300 dark:bg-gray-900">
        ...
        <div
          className={
            toggle
              ? "sidebar  bg-gray-300 dark:bg-gray-900 w-36 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out mt-10 md:mt-2"
              : "sidebar bg-gray-300 dark:bg-gray-900 w-36 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform  md:relative md:translate-x-0 transition duration-200 ease-in-out mt-10 md:mt-2"
          }
        >
          ...
          <nav className="text-center text-base text-black dark:text-gray-300">
            ...
            <div className="absolute bottom-20">
              <a
                href=""
                className="block pt-10 px-10 rounded transition duration-200"
              >
                <div className="w-12 h-12 bg-white rounded-full"></div>
              </a>
        ...
        <div className="p-4 md:p-10 text-2xl font-bold w-full">
          ...
          <div className="flex text-xl w-full">
            ...
            <input
              className="rounded-xl border-gray-300 w-full h-11"
              type="text"
            ></input>
          ...
          <div className="w-full mt-5 md:mt-10 py-10 px-4 min-h-screen bg-white rounded-xl">
            {children}
          </div>
